...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"web.png")
        ...
        det_img_btn=Image.open(r"fb.png")
        ...
        att_img_btn=Image.open(r"yt.png")
        ...
        hlp_img_btn=Image.open(r"gmail.png")
